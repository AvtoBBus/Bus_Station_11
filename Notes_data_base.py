...
def Add_to_data_base(notes_text: str, favourite: int = 0) -> None:
...
def Clear_data_base() -> None:
    with open(DB_PATH, "w", encoding="utf-8", newline="") as file:
        ...
        writerer.writerow(["Notes_text", "Create_date",
